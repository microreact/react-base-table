...
var BaseTable = /*#__PURE__*/function (_React$PureComponent) {
  ...
  (0, _createClass2["default"])(BaseTable, [{
    ...
    value: function renderExpandIcon(_ref) {
      ...
      return /*#__PURE__*/_react["default"].createElement(ExpandIcon, (0, _extends2["default"])({
        depth: depth,
        expandable: expandable,
        expanded: expanded
      }, extraProps, {
    ...
    value: function renderRow(_ref2) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_TableRow["default"], rowProps);
    }
  }, {
    key: "renderRowCell",
    value: function renderRowCell(_ref3) {
      ...
      var cell = (0, _utils.renderElement)(cellRenderer || /*#__PURE__*/_react["default"].createElement(TableCell, {
    ...
    value: function renderHeader(_ref5) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_TableHeaderRow["default"], headerProps);
    }
  }, {
    ...
    value: function renderHeaderCell(_ref6) {
      ...
      var cell = (0, _utils.renderElement)(headerRenderer || /*#__PURE__*/_react["default"].createElement(TableHeaderCell, {
      ...
      return /*#__PURE__*/_react["default"].createElement(Tag, (0, _extends2["default"])({
        ...
        style: this.columnManager.getColumnStyle(column.key),
        "data-key": column.key
      }), expandIcon, cell, column.sortable && /*#__PURE__*/_react["default"].createElement(SortIndicator, {
        sortOrder: sortOrder,
      ...
      }), column.resizable && /*#__PURE__*/_react["default"].createElement(_ColumnResizer["default"], {
    ...
    value: function renderMainTable() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_GridTable["default"], (0, _extends2["default"])({}, rest, this.state, {
...
BaseTable.propTypes = {
  ...
  onColumnExpand: _propTypes["default"].func,
